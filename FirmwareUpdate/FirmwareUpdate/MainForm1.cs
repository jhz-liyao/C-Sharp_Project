...
namespace FirmwareUpdate
{
    public partial class MainForm1 : Form
    {
        ...
        {
            string newFile = textBox2.Text.Substring(0, textBox2.Text.LastIndexOf('\\')) + "\\Image.bin";
        ...
        public static void UpdateData()
        {
            try
            {
                ...
                sp.Write(new byte[] { 0xfd }, 0, 1);
                Thread.Sleep(20);
                sp.Write(new byte[] { 0xA0 }, 0, 1);//帧类型 
                Thread.Sleep(20);
                ...
                programEXEFS.Seek(0, SeekOrigin.Begin);
                byteSingle[0] = Check_Sum;
                sp.Write(byteSingle, 0, 1);
                Thread.Sleep(20);
                //帧校验和
                Check_Sum += 0xA0;
                Check_Sum += (byte)(fileSize >> 8);
                Check_Sum += (byte)(fileSize);
                byteSingle[0] = (byte)Check_Sum;
                sp.Write(byteSingle, 0, 1);
                Thread.Sleep(20);
                sp.Write(new byte[] { 0xf8 }, 0, 1);
                Thread.Sleep(1000); 

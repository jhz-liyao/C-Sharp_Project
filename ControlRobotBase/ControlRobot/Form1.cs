...
namespace ControlRobot
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                label1.Text = "停止";
                ccmd.run(ccmd.stopCMD, "0");
            }
            //textBox1.Text = "按下"+e.KeyCode;
            sp.Write(ccmd.curCMD, 0, ccmd.stopCMD.Length);
        ...
        private void up_MouseDown(object sender, MouseEventArgs e)
        {
            label1.Text = "前进";
            ccmd.run(ccmd.upCMD, comboBox3.Text);
            sp.Write(ccmd.curCMD, 0, ccmd.upCMD.Length);
        }
        ...
        private void down_MouseDown(object sender, MouseEventArgs e)
        {
            label1.Text = "后退";
            ccmd.run(ccmd.downCMD, comboBox3.Text);
            sp.Write(ccmd.curCMD, 0, ccmd.downCMD.Length);
        }
        ...
        private void left_MouseDown(object sender, MouseEventArgs e)
        {
            label1.Text = "左转";
            ccmd.run(ccmd.leftCMD, comboBox3.Text);
            sp.Write(ccmd.curCMD, 0, ccmd.leftCMD.Length);
        }
        ...
        private void right_MouseDown(object sender, MouseEventArgs e)
        {
            label1.Text = "右转";
            ccmd.run(ccmd.rightCMD, comboBox3.Text);
            sp.Write(ccmd.curCMD, 0, ccmd.rightCMD.Length);
        }

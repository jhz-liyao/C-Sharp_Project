...
namespace FirmwareUpdate
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            //textBox4.Text.
            int fileSize = int.Parse(textBox4.Text);
            ...
            try
            {
                ...
                Thread.Sleep(20);
                sp.Write(new byte[] { (byte)(fileSize >> 8) }, 0, 1);
                Thread.Sleep(20);
                sp.Write(new byte[] { (byte)(fileSize ) }, 0, 1);
                Thread.Sleep(20);
                ...
                int offset = 0, res =-1;
                textBox4.Text = programEXEFS.Length.ToString();
                //FileStream fs =  File.Open("C:\\1.txt", FileMode.Create);
                while (res != 0)
                {
